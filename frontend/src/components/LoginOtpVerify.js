...
import '../style/LoginOtpVerify.css'
import leftImg from '../assests/login-side.jpg'
...
const LoginOtpVerify = () => {
  ...
  const userData=location.state?.userEmail
      ...
      console.log('Submitting OTP:', enteredOtp);
       try{
         ...
         if(res.ok){
          ...
          sessionStorage.setItem("dpId",result.dpId)
          sessionStorage.setItem("dpType",result.dpType)
          navigate('/home')
         }else{
   ...
   return (
    <div className="otp-container">
      ...
      <div className="otp-right">
        ...
        <h2>OTP Sent</h2>
        <p>We have sent an OTP to your mobile number and registered email address</p>
        ...
        <p className="terms">
          By clicking PROCEED, I agree to the <a href="#">AOL TnC</a>, <a href="#">AFAPL TnC</a> &
          <a href="#"> RA T&C</a>. I authorise Angel One to access my credit report from bureaus on my behalf.
        </p>
      </div>
    </div>
  );
